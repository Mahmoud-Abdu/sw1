...
const NavBar = () => {
  ...
  return (
    ...
    >
      <Box sx={{ width: "60%", display: "flex", gap: 3 }}>
        <Typography sx={style}>Home</Typography>
        <Typography sx={style}>Product</Typography>
        <Typography sx={style}>Categories</Typography>
        <Typography sx={style}>About </Typography>
        <Typography sx={style}>Contact Us</Typography>
      </Box>

      <Box sx={{ width: "10%", display: "flex", gap: 3 }}>
        <Box>
          <svg
        ...
        <Box>
          ...
          >
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M13 0.5C5.8203 0.5 0 6.3203 0 13.5C0 20.6797 5.8203 26.5 13 26.5C20.1797 26.5 26 20.6797 26 13.5C26 10.0522 24.6304 6.74558 22.1924 4.30761C19.7544 1.86964 16.4478 0.5 13 0.5ZM13 4.39995C15.1539 4.39995 16.9 6.14604 16.9 8.29995C16.9 10.4539 15.1539 12.2 13 12.2C10.8461 12.2 9.1 10.4539 9.1 8.29995C9.1 6.14604 10.8461 4.39995 13 4.39995ZM12.9997 22.5829C15.8793 22.5829 18.589 21.2199 20.3057 18.908C20.5718 18.5192 20.6066 18.0168 20.3967 17.595L20.0977 16.984C19.4436 15.649 18.0874 14.802 16.6007 14.8H9.39875C7.89091 14.8016 6.51909 15.6723 5.87575 17.036L5.60275 17.608C5.39801 18.0264 5.43273 18.5223 5.69375 18.908C7.41048 21.2199 10.1202 22.5829 12.9997 22.5829Z"
              fill="#07484A"
            />
          </svg>
        </Box>
